...
사용자의 문제를 해결하는 AI 서비스를 만드는 것에 관심이 있습니다.<br><br>

Python, FastAPI, React를 기반으로 백엔드 및 AI 서비스를 개발하고 있으며,
LLM, RAG, Computer Vision 등 다양한 AI 기술을 활용한 프로젝트를 수행했습니다.<br><br>

또한 AWS 환경에서 서비스의 배포와 운영을 경험하며,
기획부터 백엔드 개발, AI 모델 연동, 클라우드 인프라 구축까지
서비스 개발 전반을 경험하고 있습니다.<br><br>

새로운 기술을 꾸준히 배우고 프로젝트에 적용하며,
사용자에게 더 나은 가치를 제공하는 개발자가 되기 위해 노력하고 있습니다.
</p>
...
<img src="https://img.shields.io/badge/PaddleOCR-1F8ACB?style=flat-square"/>
